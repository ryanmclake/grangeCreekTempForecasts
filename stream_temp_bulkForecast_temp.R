...
forecastN <- function(IC, betaIntercept, betaX, betatemp, temp, Q = 0, n = 1){
...
write_csv(all_data, paste0(forecast$date[1],"_temp_forecast_tempModel.csv"))
...
ggsave(paste0(forecast$date[1],"_forecasts_tempModel.png"), width = 5, height = 3.7, dpi = 300)
